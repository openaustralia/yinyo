...
import (
	...
	commands "github.com/openaustralia/yinyo/pkg/commands"
...
// RecordTraffic provides a mock function with given fields: runName, external, in, out
func (_m *App) RecordTraffic(runName string, external bool, in int64, out int64) error {
	ret := _m.Called(runName, external, in, out)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, bool, int64, int64) error); ok {
		r0 = rf(runName, external, in, out)
	} else {
		r0 = ret.Error(0)
	}
