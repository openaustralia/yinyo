...
func (_m *Client) Get(path string) (io.Reader, error) {
	ret := _m.Called(path)
...
func (_m *Client) IsNotExist(_a0 error) bool {
	ret := _m.Called(_a0)
...
func (_m *Client) Put(path string, reader io.Reader, objectSize int64) error {
