...
You'll get an `id` back which you'll need in the following steps
...
(Replace the run `id` with your own value)
...
```bash
curl -X PUT "http://localhost:8080/runs/$ID/app" --data-binary @code.tgz
```
...
```bash
curl -X POST -H "Content-Type: application/json" "http://localhost:8080/runs/$ID/start" -d '{"output":"data.sqlite"}'
```
...
{"id":"1580183638633-0","time":"2020-01-28T03:53:58.625907685Z","type":"start","data":{"stage":"execute"}}
{"id":"1580183641377-0","time":"2020-01-28T03:54:01.368828538Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"Hello from test-python!"}}
{"id":"1580183641386-0","time":"2020-01-28T03:54:01.380169548Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"1..."}}
{"id":"1580183641411-0","time":"2020-01-28T03:54:01.398367334Z","type":"log","data":{"stage":"execute","stream":"stderr","text":"First a little test message to stderr"}}
{"id":"1580183642374-0","time":"2020-01-28T03:54:02.368949967Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"2..."}}
{"id":"1580183643372-0","time":"2020-01-28T03:54:03.370619368Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"3..."}}
{"id":"1580183644373-0","time":"2020-01-28T03:54:04.371837081Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"4..."}}
{"id":"1580183645376-0","time":"2020-01-28T03:54:05.37319053Z","type":"log","data":{"stage":"execute","stream":"stdout","text":"5..."}}
{"id":"1580183646397-0","time":"2020-01-28T03:54:06.38666964Z","type":"finish","data":{"stage":"execute","exit_data":{"exit_code":0,"usage":{"max_rss":136421376,"network_in":28585,"network_out":7125}}}}
...
```bash
curl "http://localhost:8080/runs/$ID/output" --output data.sqlite
```

### 7. Clean up

```bash
curl -X DELETE "http://localhost:8080/runs/$ID"
```
