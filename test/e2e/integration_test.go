...
func TestHelloWorld(t *testing.T) {
	...
	expected := []protocol.Event{
		...
		protocol.NewNetworkEvent(eventsList[9].ID, eventsList[9].Time, "build", eventsList[9].Data.(protocol.NetworkData).In, eventsList[9].Data.(protocol.NetworkData).Out),
		...
		protocol.NewNetworkEvent(eventsList[13].ID, eventsList[13].Time, "run", eventsList[13].Data.(protocol.NetworkData).In, eventsList[13].Data.(protocol.NetworkData).Out),
		protocol.NewFinishEvent(eventsList[14].ID, eventsList[14].Time, "run", eventsList[14].Data.(protocol.FinishData).ExitData),
		protocol.NewLastEvent(eventsList[15].ID, eventsList[15].Time),
	}
