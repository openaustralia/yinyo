...
func TestHelloWorld(t *testing.T) {
	...
	expected := []protocol.Event{
		...
		protocol.NewStartEvent(eventsList[11].ID, eventsList[11].RunID, eventsList[11].Time, "execute"),
		protocol.NewLogEvent(eventsList[12].ID, eventsList[12].RunID, eventsList[12].Time, "execute", "stdout", "Hello World!"),
		protocol.NewFinishEvent(eventsList[13].ID, eventsList[13].RunID, eventsList[13].Time, "execute", eventsList[13].Data.(protocol.FinishData).ExitData),
